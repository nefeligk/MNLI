...
from transformers import TrainingArguments, DistilBertForSequenceClassification, Trainer, BertForSequenceClassification
...
class MyTrainingArguments:
    ...
    gamma: float = field(default=0.001, metadata={"help": "Beta2 for AdamW optimizer"})
    final_lr: float = field(default=0.1, metadata={"help": "Beta2 for AdamW optimizer"})
...
class MyTrainer(Trainer):
    ...
    def run_id(self):
        run_id = self.hp_space(self._trial)['learning_rate']
        return run_id
    ...
    def create_optimizer(self):
        ...
        optimizer_cls, optimizer_kwargs = MyTrainer.get_optimizer_cls_and_kwargs(self.args)
    ...
    def get_optimizer_cls_and_kwargs(args: TrainingArguments) -> Tuple[Any, Any]:
        ...
        if args.optim == OptimizerNames.ADAFACTOR:
            ...
            optimizer_cls = torch_optimizer.AdaBound
            optimizer_kwargs.update(adam_kwargs)
...
dataset["validation_mismatched"][914]

dataset["validation_matched"][54]
...
print('For train0:', count0 / len(dataset["train"]))
print('For train1:', count1 / len(dataset["train"]))
print('For train2:', count2 / len(dataset["train"]))

count1 = 0
count0 = 0
count2 = 0
for i in range(len(dataset["validation_matched"])):
    if dataset["validation_matched"][i]['label'] == 1:
        count1 += 1
    if dataset["validation_matched"][i]['label'] == 2:
        count2 += 1
    if dataset["validation_matched"][i]['label'] == 0:
        count0 += 1

print('For validation_matched0:', count0 / len(dataset["validation_matched"]))
print('For validation_matched1:', count1 / len(dataset["validation_matched"]))
print('For validation_matched2:', count2 / len(dataset["validation_matched"]))

count1 = 0
count0 = 0
count2 = 0
for i in range(len(dataset["validation_mismatched"])):
    if dataset["validation_mismatched"][i]['label'] == 1:
        count1 += 1
    if dataset["validation_mismatched"][i]['label'] == 2:
        count2 += 1
    if dataset["validation_mismatched"][i]['label'] == 0:
        count0 += 1

print('For validation_mismatched0:', count0 / len(dataset["validation_mismatched"]))
print('For validation_mismatched1:', count1 / len(dataset["validation_mismatched"]))
print('For validation_mismatched2:', count2 / len(dataset["validation_mismatched"]))
...
print('For train:', count1 / len(train))
...
print('For valid:', count2 / len(valid))
...
print('For test:', count3 / len(test))
...
if sentence2_key is None:
    ...
    print(f"Sentence 1: {train[0][sentence1_key]}")
    print(f"Sentence 2: {train[0][sentence2_key]}")
...
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadabound1")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adabound1", do_eval=True,
                                    eval_steps=500,
                                    optim='adabound',
                                    learning_rate=1.6377285819200491e-06, adam_beta1=0.9025359398654065,
                                    adam_beta2=0.9386338405932445, adam_epsilon=9.271337632901637e-08,
                                    final_lr=0.14728532165034913, gamma=0.00047456253415944214,
...
def auc_multiclass(actual_class, pred_class):
    ...
    for per_class in unique_class:
        ...
        plt.plot(recall, precision, lw=2, label='class {}'.format(per_class))
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadabound2")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adabound2", do_eval=True,
                                    eval_steps=500,
                                    optim='adabound',
                                    learning_rate=1.3944336051771315e-07,
                                    adam_beta1=0.8415797275421291,
                                    adam_beta2=0.9026320759161978,
                                    adam_epsilon=9.500066503786815e-08,
                                    final_lr=0.09593548447577117,
                                    gamma=0.0009951473646574206,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadabound3")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adabound3", do_eval=True,
                                    eval_steps=500,
                                    optim='adabound',
                                    learning_rate=8.239930390913421e-07,
                                    adam_beta1=0.8215119809249479,
                                    adam_beta2=0.9815561514728133,
                                    adam_epsilon=1.5786392674611168e-08,
                                    final_lr=0.10528894433482171,
                                    gamma=0.0019873706936765017,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadabound4")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adabound4", do_eval=True,
                                    eval_steps=500,
                                    optim='adabound',
                                    learning_rate=2.8725667396039237e-07,
                                    adam_beta1=0.9075450467307657,
                                    adam_beta2=0.9145662984985042,
                                    adam_epsilon=1.0382983616619927e-09,
                                    final_lr=0.13904009450667046,
                                    gamma=0.0005378849310542367,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadabound5")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adabound5", do_eval=True,
                                    eval_steps=500,
                                    optim='adabound',
                                    learning_rate=3.4254904858599673e-06,
                                    adam_beta1=0.8160255608351653,
                                    adam_beta2=0.9142717073782983,
                                    adam_epsilon=4.4684610984388e-09,
                                    final_lr=0.12410207671264945,
                                    gamma=0.0004429299532328757,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadam1")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adam1", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    learning_rate=9.885670083978394e-06,
                                    adam_beta1=0.8570711172681886,
                                    adam_beta2=0.9405148784574102,
                                    adam_epsilon=9.918725198876617e-08,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadam2")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adam2", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    learning_rate=8.976798505863836e-06,
                                    adam_beta1=0.9491995147665119,
                                    adam_beta2=0.9953368885034005,
                                    adam_epsilon=3.428204445417191e-09,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadam3")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adam3", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    learning_rate=9.617862086199742e-06,
                                    adam_beta1=0.8495518469260367,
                                    adam_beta2=0.9497804741735424,
                                    adam_epsilon=8.426654091925936e-08,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadam4")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adam4", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    learning_rate=9.389212366067656e-06,
                                    adam_beta1=0.8142919916451177,
                                    adam_beta2=0.9310598660892602,
                                    adam_epsilon=1.7070779462361468e-08,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadam5")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adam5", do_eval=True,
                                    eval_steps=500,
                                    optim='adam',
                                    learning_rate=9.720689767889658e-06,
                                    adam_beta1=0.8048951604196096,
                                    adam_beta2=0.9361683608620415,
                                    adam_epsilon=2.5296222331993493e-08,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
class MyTrainingArguments:
    ...
    adam_beta1: float = field(default=0.9, metadata={"help": "Beta1 for AdamW optimizer"})
    adam_beta2: float = field(default=0.999, metadata={"help": "Beta2 for AdamW optimizer"})
    momentum_decay: float = field(default=0.004, metadata={"help": "Beta2 for AdamW optimizer"})
    adam_epsilon: float = field(default=1e-8, metadata={"help": "Epsilon for AdamW optimizer."})
    max_grad_norm: float = field(default=1.0, metadata={"help": "Max gradient norm."})
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgd1")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgdcustom1", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom1',
                                    learning_rate=0.000977536004361657,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgd2")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgd2", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom1',
                                    learning_rate=0.0009487267269705816,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgd3")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgd3", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom1',
                                    learning_rate=0.000978882821151807,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgd4")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgd4", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom1',
                                    learning_rate=0.000917123019566482,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgd5")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgd5", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom1',
                                    learning_rate=0.0009650090299298357,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
class MyTrainingArguments:
    ...
    adam_beta1: float = field(default=0.9, metadata={"help": "Beta1 for AdamW optimizer"})
    adam_beta2: float = field(default=0.999, metadata={"help": "Beta2 for AdamW optimizer"})
    momentum: float = field(default=0.9, metadata={"help": "Beta2 for AdamW optimizer"})
    adam_epsilon: float = field(default=1e-8, metadata={"help": "Epsilon for AdamW optimizer."})
    max_grad_norm: float = field(default=1.0, metadata={"help": "Max gradient norm."})
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgdmom1")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgdmom1", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom',
                                    learning_rate=0.0008931031666064078, momentum=0.9763186968159706,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgdmom2")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgdmom2", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom',
                                    learning_rate=0.00011349284668434341, momentum=0.9918657131566784,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgdmom3")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgdmom3", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom',
                                    learning_rate=0.00043533127798198184, momentum=0.9713266044284481,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgdmom4")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgdmom4", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom',
                                    learning_rate=0.00027858336082415864,
                                    momentum=0.9876301155462632,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIsgdmom5")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/sgdmom5", do_eval=True,
                                    eval_steps=500,
                                    optim='sgdcustom',
                                    learning_rate=4.931038503176802e-05, momentum=0.9979770990634065,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamw1")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamw1", do_eval=True,
                                    eval_steps=500,
                                    optim='adamw',
                                    learning_rate=9.932143876672889e-06,
                                    adam_beta1=0.8331918329794358,
                                    adam_beta2=0.9398100910929895,
                                    adam_epsilon=8.544799489433032e-08,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamw2")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamw2", do_eval=True,
                                    eval_steps=500,
                                    optim='adamw',
                                    learning_rate=8.962859492290143e-06,
                                    adam_beta1=0.9108728252441712, adam_beta2=0.9968720196923812,
                                    adam_epsilon=8.449649488010082e-08,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamw3")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamw3", do_eval=True,
                                    eval_steps=500,
                                    optim='adamw',
                                    learning_rate=9.922333025942261e-06,
                                    adam_beta1=0.8592352465009411,
                                    adam_beta2=0.9831353656638947,
                                    adam_epsilon=2.6175926877710697e-09,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamw4")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamw4", do_eval=True,
                                    eval_steps=500,
                                    optim='adamw',
                                    learning_rate=9.276010621445716e-06,
                                    adam_beta1=0.9384019406215863,
                                    adam_beta2=0.9929955398684195,
                                    adam_epsilon=1.030886503645033e-09,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamw5")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamw5", do_eval=True,
                                    eval_steps=500,
                                    optim='adamw',
                                    learning_rate=9.402071883648484e-06, adam_beta1=0.8732472255186048,
                                    adam_beta2=0.9707415231461045, adam_epsilon=3.1503790490048402e-09,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamax1")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamax1", do_eval=True,
                                    eval_steps=500,
                                    optim='adamax',
                                    learning_rate=9.888763163706935e-06,
                                    adam_beta1=0.9488948169171472,
                                    adam_beta2=0.9024243745638912,
                                    adam_epsilon=1.9696031038880562e-08,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamax2")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamax2", do_eval=True,
                                    eval_steps=500,
                                    optim='adamax',
                                    learning_rate=9.827705399783784e-06,
                                    adam_beta1=0.9045325803260116,
                                    adam_beta2=0.9044100629416028,
                                    adam_epsilon=1.0199442709826698e-09,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamax3")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamax3", do_eval=True,
                                    eval_steps=500,
                                    optim='adamax',
                                    learning_rate=7.368142934580329e-06,
                                    adam_beta1=0.8579135946653244,
                                    adam_beta2=0.9143764544628249,
                                    adam_epsilon=9.718786288981358e-09,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLIadamax4")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamax4", do_eval=True,
                                    eval_steps=500,
                                    optim='adamax',
                                    learning_rate=9.161041887662051e-06,
                                    adam_beta1=0.8420521365395014,
                                    adam_beta2=0.9464176437117162,
                                    adam_epsilon=9.188424557878425e-08,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/adamax5", do_eval=True,
                                    eval_steps=500,
                                    optim='adamax',
                                    learning_rate=9.720689767889658e-06,
                                    adam_beta1=0.8048951604196096,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLInadam1")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/nadam1", do_eval=True,
                                    eval_steps=500,
                                    optim='nadam',
                                    learning_rate=9.415191069782868e-06,
                                    adam_beta1=0.8013968453021459,
                                    adam_beta2=0.9995368919755019,
                                    adam_epsilon=1.605552033157199e-08,
                                    momentum_decay=0.00010116176716837175,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLInadam2")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/nadam2", do_eval=True,
                                    eval_steps=500,
                                    optim='nadam',
                                    learning_rate=9.928393354899699e-06,
                                    adam_beta1=0.9263687084501293, adam_beta2=0.9211836696768243,
                                    adam_epsilon=4.6108768745155285e-09, momentum_decay=0.00010025531294302891,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLInadam3")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/nadam3", do_eval=True,
                                    eval_steps=500,
                                    optim='nadam',
                                    learning_rate=9.355820004092559e-06,
                                    adam_beta1=0.8395618480504946,
                                    adam_beta2=0.9788913712757527,
                                    adam_epsilon=1.3624826247439611e-08,
                                    momentum_decay=0.00016827726691431217,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
# Log in to your W&B account
# wandb.login()
# run = wandb.init(project="mnli", name="MNLInadam4")
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/nadam4", do_eval=True,
                                    eval_steps=500,
                                    optim='nadam',
                                    learning_rate=9.54330306233984e-06,
                                    adam_beta1=0.9287113600596156,
                                    adam_beta2=0.9259848495275261,
                                    adam_epsilon=1.1488896426832136e-09,
                                    momentum_decay=0.0011794903568569338,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
...
training_args = MyTrainingArguments("/home/LCARS/mirasta/nadam5", do_eval=True,
                                    eval_steps=500,
                                    optim='nadam',
                                    learning_rate=9.6567925159082e-06,
                                    adam_beta1=0.8008652040493361,
                                    adam_beta2=0.9322734451870868,
                                    adam_epsilon=1.0284035713174961e-09,
                                    momentum_decay=0.001692774228149035,
                                    per_device_train_batch_size=4,
                                    per_device_eval_batch_size=4,
                                    evaluation_strategy="steps",
                                    logging_steps=500,
